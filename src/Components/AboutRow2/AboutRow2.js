    ...
    <div className='main_about_row2'>
       <div className='heading1_about_row2'>
         ...
         <motion.h1
          ...
          whileInView={{ opacity: 1, scale:1 }}
          transition={{duration:0.6}}
         className='description_1_about_row2'>Our mission is to deliver excellent products and services to our customers, while also contributing to the economic and social development of the communities in which we operate.
         </motion.h1>
