...
import { image31, services0, services30, services2,ankle_support,body_belts,forearm_product,fracture_aids,image_placeholder,finger,traction,wellnes } from '../Assets'
...
function Medical() {
  return (
    <div>
      ...
      />
      <ProductsItem productImage={finger} productTitle='Finger Supports'
     ...
     />
      ...
      />
      <ProductsItem productImage={traction} productTitle='Traction Aids'
      ...
      />
      <ProductsItem productImage={wellnes} productTitle='Wellness Products'
